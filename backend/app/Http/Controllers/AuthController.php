...
class AuthController extends Controller
{
    ...
    public function login(Request $request) {
        $validator = Validator::make([
            'email' => 'required|email', // unique:users,email means that the email field must be unique in the users table
            'password' => 'required|string', // confirmed means that the password field must be confirmed by the user
        ]);
